...
/**
 * Copy from "code-settings-sync"
 * https://github.com/shanalikhan/code-settings-sync/blob/master/src/localize.ts
 */
...
export class Localize {
  ...
  private resolveLanguagePack(): LanguagePack {
    ...
    let rootPath: any;
    rootPath = extensions.getExtension('dteam.dbox-repo')?.extensionPath;
